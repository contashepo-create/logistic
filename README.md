...
```bash
# 1) اختبار المنطق الأساسي (32 فحصاً)
python scripts/smoke_test.py

# 2) الفحص الشامل المحاسبي والأمني (555+ فحصاً):
#    - التقارير الخمسة والكشوف مقابل إعادة حساب SQL مستقلة
...
# 3) فحص الواجهة العميق (138+ فحصاً):
