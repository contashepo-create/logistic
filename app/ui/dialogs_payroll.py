...
class PayrollDialog(QDialog):
    ...
    def __init__(self, parent=None, payroll_id: int | None = None,
        ...
        self.net_label.setStyleSheet("font-size:14pt; font-weight:bold; color:#1e4fc4;")
        ...
        self.adv_table.verticalHeader().setDefaultSectionSize(40)
        ...
        self.ded_table.verticalHeader().setDefaultSectionSize(40)
        self.ded_table.horizontalHeader().setSectionResizeMode(
            QHeaderView.ResizeMode.ResizeToContents)
        self.ded_table.horizontalHeader().setStretchLastSection(True)
